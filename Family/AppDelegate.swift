...
//AIzaSyBXn4Gphd-XyqOTEpJecCURmEAtlO5gfiU
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSServices.provideAPIKey("AIzaSyBXn4Gphd-XyqOTEpJecCURmEAtlO5gfiU")
...
//    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        ...
        var persistentContainer: NSPersistentContainer = {
          let groupName = "group.com.contoso.CloudModel"
          let url = FileManager.default
            .containerURL(forSecurityApplicationGroupIdentifier: groupName)!
            .appendingPathComponent("CloudModel.sqlite")

          let container = NSPersistentContainer(name: "CloudModel")
